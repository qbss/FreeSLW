...
#ifndef __OPENAL_LISTENER_H
#define __OPENAL_LISTENER_H
...
namespace openal
{
	...
	private:
		...
		EAXSet alEAXSet;
		EAXGet alEAXGet;
		_EAXLISTENERPROPERTIES defaultEAX;
		_EAXLISTENERPROPERTIES eaxProperties[freeslw::AE_NONE];

	private:
		void EAXEnv(_EAXLISTENERPROPERTIES& env,
